...
public class EstudiantesCultura extends JFrame {
    ...
    public static void addRows(DefaultTableModel model){
        ...
        try { estudianteList = EstudiantesController.getCulturaEstudiantes(); } catch(Throwable t){ t.printStackTrace(); }
    ...
    private static class StudentFormDialog extends JDialog {
        ...
        private void saveEstudianteCult(Object[] prefill) {
            Estudiante estudiante = prefill != null
                    ? EstudiantesController.getEstudianteCulturaByCarnet((String) prefill[3])
                    : new Estudiante();
            ...
            estudiante.setTipoEstudiante(EstudiantesController.getTipoEstudiantes().get(1));
