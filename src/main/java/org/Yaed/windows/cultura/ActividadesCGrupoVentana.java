...
public class ActividadesCGrupoVentana extends JFrame {
    ...
    public ActividadesCGrupoVentana() {
        setTitle("SCEBE - Actividades del Grupo Cultural");
...
// Iconos (AntDesign Icons)
        ...
        JLabel lblTitulo = new JLabel("Actividades del grupo cultural");
...
//Datos de ejemplo
        List<ActividadesEstudiantesCultura> actividades = CulturaController.getAllActividadesGruposCultura();

        for (ActividadesEstudiantesCultura act : actividades){
            ...
            GruposCulturaEstudiantes grupoEstudiante = CulturaController
                    .getAllGrupoCulturaEstudiante()
                    .stream()
            ...
            if (grupoEstudiante != null) {
                String grupo = grupoEstudiante.getGrupoCultura().getNombre();
    ...
    private void eliminarSeleccion() {
        ...
        List<ActividadesEstudiantesCultura> acts = CulturaController.getAllActividadesGruposCultura();
        for (ActividadesEstudiantesCultura e : acts){
            if (e.getActividad().getNombre().equalsIgnoreCase(actividad)){
                CulturaController.deleteActividadesGruposCultura(e);
            }
        }
...
// ComboBox inicial con algunos tipos
            ...
            List<TipoActividadCultura> tiposActividad = CulturaController.getAllTipoActividadCultura();
            for (TipoActividadCultura t : tiposActividad){
...
// Botón + para agregar un nuevo tipo
            ...
            btnAddTipo.addActionListener(e -> {
                ...
                if (nuevoTipo != null && !nuevoTipo.trim().isEmpty()) {
                    ...
                    TipoActividadCultura tipoActividad = new TipoActividadCultura();
                    tipoActividad.setNombre(nuevoTipo.trim());
                    CulturaController.saveTipoActividadCultura(tipoActividad);
...
//            );
        ...
        private void onSave() {
            ...
            // =======================
            ActividadCultura nuevaActividad = new ActividadCultura();
            ...
            // =======================
            TipoActividadCultura tipoSeleccionado = null;
            for (TipoActividadCultura t : CulturaController.getAllTipoActividadCultura()) {
                if (t.getNombre().equalsIgnoreCase(categoria)) {
                    tipoSeleccionado = t;
                    break;
                }
            }
            nuevaActividad.setTipoActividadCultura(tipoSeleccionado);

            // =======================
            // 3. (Opcional) guardar la actividad primero
            //     si tu saveActividadesGruposDeportes NO guarda actividad automáticamente
            CulturaController.saveActividadCultura(nuevaActividad);
            // =======================
            ...
            // =======================
            List<GruposCulturaEstudiantes> gruposEst =
                    CulturaController.getAllGrupoCulturaEstudiante();

            for (GruposCulturaEstudiantes ge : gruposEst) {

                if (ge.getGrupoCultura().getNombre().equalsIgnoreCase(grupo)) {
                    ...
                    // =======================
                    ActividadesEstudiantesCultura rel = new ActividadesEstudiantesCultura();
                    ...
                    // =======================
                    CulturaController.saveActividadesGruposCultura(rel);
                }
            }
