...
public class ActividadesCHistorialVentana extends JFrame {
    private DefaultTableModel model;
    private JTable table;
    private JTextField tfBuscar;

    public ActividadesCHistorialVentana() {
        setTitle("SCEBE - Historial de actividades culturales");
...
// Iconos (AntDesign Icons)
    ...
    private void abrirHistorialActividad() {
        WindowManager.abrir("HistorialActividad", new ActividadesCGrupoVentana());
    }
    ...
    public static void addRows(DefaultTableModel model) {
        List<ActividadesEstudiantesCultura> actividadesList = CulturaController.getAllActividadesGruposCultura();
        List<GruposCulturaEstudiantes> gruposEstudiantesList = CulturaController.getAllGrupoCulturaEstudiante();

        for (ActividadesEstudiantesCultura actividadEstudiante : actividadesList) {
            ...
            String grupoNombre = "—";
            for (GruposCulturaEstudiantes gde : gruposEstudiantesList) {
                if (gde.getEstudiante().getCarnet().equals(estudiante.getCarnet())) {
                    grupoNombre = gde.getGrupoCultura().getNombre();
