...
public class EditarGrupoForm extends JDialog {
    ...
    private GrupoDeporte grupoExistente;

    private boolean saved = false;

    public EditarGrupoForm(Window owner, GrupoDeporte grupoExistente) {
    ...
    private void cargarDatosExistentes() {
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            boolean pertenece = grupoExistente.getGruposDeportes().stream()
    ...
    private void guardarGrupo() {
        ...
        for (int r : sel) {
            ...
            if (asignacion != null) {
                if (asignacion.getGrupoDeporte().getId() != grupoExistente.getId()) {
                    JOptionPane.showMessageDialog(this,
        ...
        DeportesController.updateGrupoDeporte(grupoExistente);

        if (grupoExistente.getGruposDeportes() != null) {
            grupoExistente.getGruposDeportes().clear();
        }
        ...
        for (Estudiante estSel : estudiantesSeleccionados) {
            ...
            gde.setGrupoDeporte(grupoExistente);
