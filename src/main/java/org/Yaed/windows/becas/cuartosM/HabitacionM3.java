...
public class HabitacionM3 extends JFrame {
    public HabitacionM3() {
        setTitle("Casa Mediana 3");
        ...
        JLabel titleLabel = new JLabel("Casa Mediana 3 (Masculino)");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 26));
        titleLabel.setForeground(accentColor);
        titleLabel.setHorizontalAlignment(SwingConstants.CENTER);

        JLabel subtitleLabel = new JLabel("Cuarto 3");
