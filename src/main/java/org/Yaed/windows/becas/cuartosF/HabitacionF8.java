package org.Yaed.windows.becas.cuartosF;
...
public class HabitacionF8 extends JFrame {
    public HabitacionF8() {
        setTitle("Casa Pequeña 8");
        ...
        JLabel titleLabel = new JLabel("Casa Pequeña 8 (Femenino)");
